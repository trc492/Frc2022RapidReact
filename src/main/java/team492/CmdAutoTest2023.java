...
class CmdAutoTest2023 implements TrcRobot.RobotCommand
{
    ...
    public boolean cmdPeriodic(double elapsedTime)
    {
        ...
        else
        {
            ...
            switch (state)
            {
                case SCORE: //Scores a game piece, the precondition being that it is already in the scoring position, with a game piece in the robot, broadacasting event when complete
                    //calls autoscore
                    piecesScored++;
                    if (piecesScored == 1) {
